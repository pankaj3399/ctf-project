...
const Dashboard = () => {
    ...
    const { data, isError, isLoading, isSuccess } = useGetAllChallengesQuery()
    ...
    return (
        <div className='p-5 h-full'>
            ...
            <div className="mx-4 relative h-full">
                ...
                {
                    isLoading ? <div className="flex justify-center items-center h-1/2 tracking-wider text-[32px] font-semibold"> <LoaderIcon style={{
                        width: '25px',
                        height: '25px'
                    }} /></div> : <ChallengeDashboard activeCategory={selectedCategory} datas={data?.data} ></ChallengeDashboard>
                }
