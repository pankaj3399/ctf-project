...
const AddNewChallenge = () => {
  ...
  const [createChallenge] = useCreateChallengeByUserMutation();
  ...
  return isLoading || isFetching ? (
      ...
      <div className="mx-4 relative h-full">
        ...
        <div>
          ...
          <form
            ...
            className=" rounded px-8 pt-6 pb-16 my-4"
          >
            <div className="mb-4">
            ...
            <div className="flex items-center justify-between">
              <button
                className="bg-red-600 hover:bg-red-800 text-white py-1.5 px-3 rounded-full"
                type="submit"
              >
                Create Challenge
              </button>
    ...
    <div className="flex flex-col gap-4 items-center justify-center w-full h-full">
      <p className="text-center text-red-600">
        You need to solve All Challenged added by Admin
      </p>
